...
namespace GoogleFitOnFhir.Identity
{
    public class Startup : FunctionsStartup
    {
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddSingleton<IGoogleFitAuthUriRequest, GoogleFitAuthUriRequest>();
            builder.Services.AddSingleton<IGoogleFitAuthTokensRequest, GoogleFitAuthTokensRequest>();
            builder.Services.AddSingleton<IGoogleFitRefreshTokenRequest, GoogleFitRefreshTokensRequest>();
